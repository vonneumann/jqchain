...
<head>
	<meta charset="utf-8">
	<title>DSP2P-Dswjcms安装程序</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="DSP2P傻瓜式一键安装，佣有一套商城只需10秒">
	<meta name="KeyWords" content="DSP2P安装,dsphp一键安装,dsphp程序安装">
    <meta name="generator" content="DSP2P!" />
...
<body>
	<div class="container index">
        ...
        <div class="name">DSP2P</div>
        <div id="sp-1" <?php if(($state) == "1"): ?>class="hide"<?php endif; ?>>
            <div class="describe">傻瓜式安装，搭建P2P网贷平台最快只需10秒</div>
