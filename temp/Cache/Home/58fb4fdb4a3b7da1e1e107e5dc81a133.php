...
<div class="container">
	<div class="row-fluid  wall statis">
            <article class="span3">
                融资金额
                <span class="amount"><?php echo (number_format($accumulate["sum"],2,'.',',')); ?><span class="decimals">万元</span></span>
            </article>
            <article class="span3">
                融资笔数
                <span class="amount"><?php echo (number_format($accumulate["benefit"],0,'.',',')); ?><span class="decimals">笔</span></span>
            </article>
            <article class="span3">
                供应商
                <span class="amount"><?php echo (number_format($accumulate["avg"],0,'.',',')); ?><span class="decimals">家</span></span>
            </article>
            <article class="span3">
                核心企业
                 <span class="amount"><?php echo ($accumulate["enrollment"]); ?><span class="decimals">家</span></span>
            </article>
    </div>   
...
<!--借款标 end-->
    <p style="text-align: center">
        ...
        <div class="span3 post-thumbnail">
                <section>
                    <a href="__ROOT__/Site/listTpl/id/16.html" class="more">更多</a>
                    <h3>新闻中心</h3>
                    <ul>
