            ...
            <div class="navbar navbar-inverse">
                <div class="navbar-inner">
                 <?php if($b["id"] > 0 ): ?><ul class="nav">
                        <li <?php if(($b["type"]) == "1"): ?>class="active"<?php endif; ?>><a href="__ROOT__/Borrow/index/mortgage.html">应收账款融资</a></li>

                        
                    </ul>
                 <?php else: ?>
                 	<ul class="nav">
                        <li <?php if(($_GET['mid']) == "mortgage"): ?>class="active"<?php endif; ?>><a href="__ROOT__/Borrow/index/mortgage.html">应收账款融资</a></li>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
          <tr>
            ...
            <td>
                   <input name="title" type="text" class="span5"  maxlength="25"  datatype="*" nullmsg="请输入标题！" value="<?php echo ($b["title"]); ?>">
            </td>
        ...
        <tbody>
          <tr>
            ...
            <td>
                ...
                <?php if($_GET['mid']== 'guarantee'): ?><input name="money" type="text" class="span2" onkeyup="var money=$(this).val();$('#surplus').val(money);$('#assure').val(money);moneys(money);" maxlength="7"  datatype="n3-7" nullmsg="请输入借款金额！"><span class="add-on">元</span>
                   	<input id="assure" name="assure" type="hidden" />
                    <input id="surplus" name="surplus" type="hidden" />
                <?php else: ?>
                    <input name="money" value="<?php if(($b["money"]) >= "1"): echo (floor($b["money"])); endif; ?>" type="text" class="span8"  onkeyup="var money=$(this).val();$('#surplus').val(money);moneys(money);" maxlength="7"  datatype="n3-7" nullmsg="请输入借款金额！"><span class="add-on">元</span>
