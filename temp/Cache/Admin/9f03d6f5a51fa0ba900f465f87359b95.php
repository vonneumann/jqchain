...
<!-- left menu ends -->
 ...
 <form method="post"  action='__APP__/TIFAWEB_DSWJCMS/Site/tfAdd'>
 <input name="user_id" type="hidden" value="<?php echo ($user_id); ?>" />
  <input name="catpid" id="catpid" type="hidden" value="<?php echo ($catpid); ?>" />
                    ...
                    <table class="table">
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <input name="title" type="text" class="span5" placeholder="请输入分类名称..." maxlength="30">
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                        <?php if($catpid ): ?><select name="pid" id="pid">
                                                <option value="<?php echo ($pid); ?>" id="Type"><?php echo ($list['title']); ?></option>
                                            </select>                                          
                              ...
                              <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td class="form-inline">
                                          <label class="radio"><input type="radio" name="type" value="1" checked  onclick="$('#content_tpl').val('content')"/> 封面</label>
                                       ...
                                       <tr>
                                        ...
                                        <td class="form-inline">
                                              <input name="content_tpl"  id="content_tpl" type="text" class="span5" value="content">
                                        </td>
                                      </tr>                                                                                                               
                                    ...
                                    <?php if($list['newOrder'] ): ?><input id="order" name="order" type="hidden" class="span2"  value="<?php echo ($list['newOrder']); ?>">
                                     <?php else: ?>
                                     <input id="order" name="order" type="hidden" class="span2"  value="1"><?php endif; ?>
